...
| الحالة | T5 جاهز للمراجعة عبر PR #102: اتصال التاجر المشفر وواجهته المنقحة ناجحان في جميع البوابات؛ تفعيل الدفع الفعلي ما زال محجوبًا بملحق المزود المتبقي |
...
- ثُبّت التنفيذ في Commit ‏`5bfc412` ورُفع على الفرع نفسه، وفُتح PR #102 بحالة Ready؛ لم يحدث Merge ولم يبدأ WP 5.29B.
