...
final class ProductCatalogContract
{
    ...
    public static function validator(array $catalog, ?int $maxProducts, bool $legacyCompatibleIds = false): Validator
    {
        ...
        $validator = ValidatorFacade::make($normalized, [
            ...
            'products.*' => ['array:id,revision,status,name,price,basePrice,salePrice,description,category,imageKeyword,imageUrl,imageUrls,stockQuantity,reservedQuantity,availableQuantity,inventoryRevision,manageStock,sku,lowStockThreshold'],
            ...
            'products.*.reservedQuantity' => ['nullable', 'integer', 'min:0', 'max:1000000000'],
            'products.*.availableQuantity' => ['nullable', 'integer', 'min:0', 'max:1000000000'],
            'products.*.inventoryRevision' => ['nullable', 'integer', 'min:1'],
