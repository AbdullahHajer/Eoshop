...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE platform_assets ADD CONSTRAINT platform_assets_state_valid CHECK (state IN ('staging', 'ready', 'quarantined'))");
