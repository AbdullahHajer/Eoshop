  ...
  return (
    ...
    >
      ...
      <StorefrontHeaderDispatcher
        ...
        tokens={{ surface: cardBgColor, ink: secondaryOnCard, mutedInk: effectiveTextColor, border: borderColor, accent: isElegant ? primaryOnWhite : primaryColor }}
        onSearchChange={(value) => {
          setSearchQuery(value);
          if (storePage !== "products" && storePage !== "home" && value.trim()) navigateToStorePage("products");
        }}
        ...
        onOpenCart={openCart}
        onSelectCategory={(category) => { setSelectedCategory(category); navigateToStorePage("products"); }}
      />
