...
export const TECH_PRESET: StoreConfig = {
  ...
  email: "support@techview.sa",
  address: "جدة، شارع الأمير سلطان - المملكة العربية السعودية",
  workingHours: "يومياً من 10:00 صباحاً حتى 12:00 منتصف الليل",
  whatsapp: "+966559876543",
  instagram: "techview_sa",
  twitter: "techview_sa",
  tiktok: "techview_sa",
  snapchat: "techview_sa",
